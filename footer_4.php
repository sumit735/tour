...
<body>
	...
	<section id="hero">
		<div class="intro_title">
			<h3 class="animated fadeInDown">Citytours Footer style 4</h3>
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1 text-center">
						...
						<form method="post" action="assets/newsletter.php" name="newsletter_2" id="newsletter_2">
							...
							<button id="submit-newsletter_2" class="btn_1">Subscribe</button>
						</form>
					</div>
				</div>
			</div>
	...
	<footer id="footer_3" class="revealed">
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-12 col-sm-12">
					<p><img src="img/logo.png" width="160" height="34" alt="City tours" data-retina="true" id="logo">
					</p>
