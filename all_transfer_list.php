					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_transfer.html"><img src="img/transfer_2.jpg" alt="Image">
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_transfer.html"><img src="img/transfer_1.jpg" alt="Image">
										<div class="short_info"></div>
									</a>
								</div>
							</div>
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_transfer.html"><img src="img/transfer_3.jpg" alt="Image">
										<div class="short_info"></div>
									</a>
								</div>
							</div>
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_transfer.html"><img src="img/transfer_4.jpg" alt="Image">
										<div class="short_info"></div>
									</a>
								</div>
							</div>
