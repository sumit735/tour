						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control booking_date" id="bookingdate" type="text" data-lang="en" data-min-year="2017" data-max-year="2020" data-disabled-days="11/17/2017,12/17/2017">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
