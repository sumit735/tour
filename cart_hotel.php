			...
			<div class="row">
				<div class="col-lg-8">
					<div class="alert alert-info" role="alert"><strong>Rooms available</strong> for the selected dates.
						<br>PLEASE SELECT YOUR QUANTITY.</div>
					<table class="table table-striped cart-list add_bottom_30">
						...
						<tbody>
							<tr>
								<td>
									<div class="thumb_cart">
										<a href="#" data-toggle="modal" data-target="#modal_single_room"><img src="img/thumb_cart_1.jpg" alt="Image">
										</a>
									</div>
							...
							<tr>
								<td>
									<div class="thumb_cart">
										<a href="#" data-toggle="modal" data-target="#modal_double_room"><img src="img/thumb_cart_1.jpg" alt="Image">
										</a>
									</div>
