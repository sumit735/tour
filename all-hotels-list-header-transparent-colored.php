			...
			<div class="row">
				<div class="col-3">
					<div id="logo">
						...
						<a href="index.html"><img src="img/logo_sticky_colored.png" width="160" height="34" alt="City tours" data-retina="true" class="logo_sticky"></a>
					</div>
				</div>
				<nav class="col-9">
							...
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_hotel.html">
										<div class="ribbon popular"></div><img src="img/hotel_1.jpg" alt="Image">
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_hotel.html">
										<div class="ribbon top_rated"></div><img src="img/hotel_3.jpg" alt="Image">
										<div class="short_info"></div>
									</a>
								</div>
							</div>
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_hotel.html">
										<div class="ribbon top_rated"></div><img src="img/hotel_4.jpg" alt="Image">
										<div class="short_info"></div>
									</a>
								</div>
							</div>
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_hotel.html">
										<div class="ribbon top_rated"></div><img src="img/hotel_5.jpg" alt="Image">
										<div class="short_info"></div>
									</a>
								</div>
							</div>
