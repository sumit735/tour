                    ...
                    <div class="main-menu">
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="all_tours_list.php">All tours list</a></li>
                                    <li><a href="all_tours_grid.php">All tours grid</a></li>
                                    <li><a href="all_tours_map_listing.php">All tours map listing</a></li>
                                    <li><a href="single_tour.php">Single tour page</a></li>
                                    <li><a href="single_tour_with_gallery.php">Single tour with gallery</a></li>
	...
	<main>
		...
		<div class="container margin_60">
			...
			<p class="text-center nopadding">
				<a href="all_hotels_list.html" class="btn_1 medium"><i class="icon-eye-7"></i>View all packages (70) </a>
			</p>
