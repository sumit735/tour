					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.2s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_restaurant.html"><img src="img/restaurant_box_2.jpg" alt="Image">
										<div class="short_info"><i class="icon_set_3_restaurant-2"></i> Fast food</div>
									</a>
								</div>
							</div>
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.3s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_restaurant.html"><img src="img/restaurant_box_3.jpg" alt="Image">
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.4s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_restaurant.html"><img src="img/restaurant_box_4.jpg" alt="Image">
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.5s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_restaurant.html"><img src="img/restaurant_box_5.jpg" alt="Image">
					...
					<div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.7s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="single_restaurant.html"><img src="img/restaurant_box_6.jpg" alt="Image">
