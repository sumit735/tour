			...
			<ul class="cbp_tmtimeline">
				<li>
					...
					<div class="cbp_tmlabel">
						<div class="float-right d-none d-md-block">Guide <strong>John Doe</strong><img src="img/guide_1.jpg" alt="Image" class="rounded-circle speaker">
						</div>
				...
				<li>
					...
					<div class="cbp_tmlabel">
						<div class="float-right d-none d-md-block">Guide <strong>John Doe</strong><img src="img/guide_2.jpg" alt="Image" class="rounded-circle speaker">
						</div>
