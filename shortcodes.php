        ...
        <div class="col-lg-8">
                ...
                <!-- Headings & Paragraph Copy -->         
                  ...
                  <div class="row">
                  	<div class="col-md-12 add_bottom_30">
                          <h3>Buttons</h3>
                       		<a href="#" class="btn_1">Button</a>  <a href="#" class="btn_1 outline">Button</a> <a href="#" class="btn_1 white">Button</a> 
                            <a href="#" class="btn_1 green">Button</a> <a href="#" class="btn_1 medium">Button</a>  <br><br>
                            <a href="#" class=" btn_full">Button</a>  <a href="#" class="btn_full_outline">Button</a>
                    </div>
      				</div>
                ...
                <div class="row">
                 ...
                 <hr>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-6">
                          <ul class="tooltips_demo">
                            <li>
                            <div class="tooltip_styled tooltip-effect-1">
                            	<span class="tooltip-item">Effect 1</span>
                                	<div class="tooltip-content">Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel, dapibus id, mattis vel, nisi.</div>
                              </div>
                        	</li>
                            <li>
                  ...
                  <div class="accordion_styled" id="accordion">
					  ...
					  <div class="card">
						<div class="card-header">
						  <h4>
							<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne_payment">Anim pariatur cliche reprehenderit?<i class="indicator icon-minus float-right"></i></a>
						  </h4>
						</div>
						<div id="collapseOne_payment" class="collapse show" data-parent="#accordion">
						  <div class="card-body">
					  ...
					  <div class="card">
						<div class="card-header">
						  <h4>
							<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo_payment">Parsnip lotus root celery?<i class="indicator icon-plus float-right"></i></a>
						  </h4>
						</div>
						<div id="collapseTwo_payment" class="collapse" data-parent="#accordion">
						  <div class="card-body">
							Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
						  </div>
						</div>
					  ...
					  <div class="card">
						<div class="card-header">
						  <h4>
							<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree_payment">Beet greens peanut salad?<i class="indicator icon-plus float-right"></i></a>
						  </h4>
						</div>
						<div id="collapseThree_payment" class="collapse" data-parent="#accordion">
						  <div class="card-body">
							Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
						  </div>
						</div>
               ...
               <div class="row magnific-gallery">
                   <div class="col-md-6">
                   		<a href="img/notredame.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="img/notredame.jpg" alt="Image" class="img-fluid"></a>
                   </div>
                   <div class="col-md-6">
                   		<a href="img/senna.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="img/senna.jpg" alt="Image" class="img-fluid"></a>
                   </div>
               </div><!-- End row-->
               ...
               <div class="row magnific">
                   <div class="col-md-6">
                   		<a href="https://vimeo.com/45830194" class="video" title="Video title"><img src="img/notredame.jpg" alt="Image" class="img-fluid"></a>
                   </div>
                   <div class="col-md-6">
                   		<a href="https://www.youtube.com/watch?v=Zz5cu72Gv5Y"  class="video" title="Video title"><img src="img/senna.jpg" alt="Image" class="img-fluid"></a>
                   </div>
               </div><!-- End row-->
